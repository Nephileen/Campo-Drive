...
public class GUIWindow extends JComponent implements KeyListener, MouseListener{
    ...
    //Linked to the ArrayList of the associated ScrollingGameEngine object
    ...
    public GUIWindow(int windowWidth, int windowHeight, ArrayList<Entity> displayList){
        this.displayList = displayList; //Link this displayList to the respective ScrollingGameEngine
    ...
    //Called by ScrollingGameEngine to redraw the window and all of the Entities in it   
    public void refresh(){
        this.repaint();
    ...
    public void keyPressed(KeyEvent event) { 
        ...
        if (keyCode == ScrollingGameEngine.KEY_QUIT_GAME)
            System.exit(0);    
        else if (keyCode == ScrollingGameEngine.KEY_TOGGLE_DEBUG)
    ...
    public void setBackgroundImage(String filename){
        ...
        backgroundImage = GUIWindow.readImage(bgImageFile);             
    }
    ...
    public void setSplashImage(String filename){
        splashImage = GUIWindow.readImage(filename);  
    ...
    public static Image readImage(String filename){
        ...
        URL imageResource = GUIWindow.class.getResource(filename);
