...
public abstract class ScrollingGameEngine {
    ...
    public ScrollingGameEngine(int gameWidth, int gameHeight){
    ...
    private void initializeGame(int gameWidth, int gameHeight){
        //We need to pass GUIWindow a reference to our displayList at instantation
        window = new GUIWindow(gameWidth, gameHeight, displayList); 
